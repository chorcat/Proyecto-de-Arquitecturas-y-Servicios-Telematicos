...
public class OpenCloseBD implements ServiceLifeCycle {
	...
	public void shutDown(ConfigurationContext arg0, AxisService arg1) {
		...
		ObjectContainer db = (ObjectContainer) arg0.getProperty("db_conexion");
		db.close();
		delete();
	}
	...
	public void startUp(ConfigurationContext arg0, AxisService arg1) {
		...
		ObjectContainer db = Db4oEmbedded.openFile(Db4oEmbedded.newConfiguration(), "Usuarios.db4o");
		arg0.setProperty("db_conexion", db);
	...
	public void publish() {
		try {
			...
			myServName.setValue("Autentificador");
			...
			accessPoint.setValue("http://localhost:8181/axis2/services/Autentificador?wsdl");
